...
contract Lottery {
    ...
    /**
     * @dev   베팅과 정답 체크를 한다. 유저는 0.005ETH를 보내야하고 배팅용 1byte 글자를 보낸다.
    ...
    /**
     * @dev 베팅 결과값을 홗인하고 팟머니를 분배한다.
     * 정답 실패 : 팟머니 축척, 정답 맞춤 : 팟머니 획득, 한글자 맞춤 or 정답 확인 불가 : 베팅금액만 획득
     */
